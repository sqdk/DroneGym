...
public sealed class PidController
{
    ...
    public double ControlVariable(TimeSpan timeSinceLastUpdate)
    {
        ...
        IntegralTerm += (GainIntegral * error * timeSinceLastUpdate.TotalMilliseconds);
        IntegralTerm = Clamp(IntegralTerm);

        // derivative term calculation
        double dInput = processVariable - ProcessVariableLast;
        double derivativeTerm = GainDerivative * (dInput / timeSinceLastUpdate.TotalMilliseconds);
